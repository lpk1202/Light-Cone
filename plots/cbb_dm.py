...
o2 = (np.loadtxt('../../../../Downloads/d3.txt')+0.18)/(0.36)

o3 = (np.loadtxt('../../../../Downloads/dd3.txt')+0.18)/(0.36)
o5 = (np.loadtxt('../../../../Downloads/ooo.txt')+0.18)/(0.36)
...
for i in np.arange(7):
	for j in np.arange(7):
		for k in np.arange(7):
			if abs(oo3[i][j][k]-0.6958116077236357)<=1e-7:
				print(i,' ',j,' ',k)
...
# cbar = fig.colorbar(surf, ax=axlist,cmap=cmap_r,ticks=[0,0.25, 0.5, 0.75,1],aspect=40,pad=0.08,shrink=0.904,orientation='horizontal')
