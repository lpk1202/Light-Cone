...
# o2 = np.loadtxt('../../../../Downloads/d3.txt')

# o3 = np.loadtxt('../../../../Downloads/dd3.txt')
# o5 = np.loadtxt('../../../../Downloads/ooo.txt')
o2 = np.loadtxt('../../nbodykit/fastpm-python/Example_Full/data/d3_dm.txt')

o3 = np.loadtxt('../../nbodykit/fastpm-python/Example_Full/data/dd3_dm.txt')
o5 = np.loadtxt('../../nbodykit/fastpm-python/Example_Full/data/ooo_dm.txt')
...
ax00.text(7,-0.33*7*np.sqrt(3), -0.5, r"$d_{\rm m}(\vec{r})$",fontsize=28)
...
ax0.text(7,-0.33*7*np.sqrt(3), -1.7, r"$\hat{d}_{\rm m}(\vec{r})$",fontsize=28)
...
ax.set_zticks([])
ax.set_axis_off()
ax.text(7,-0.33*7*np.sqrt(3), -1.1, r"${d}_{\rm m}(\vec{r})$",fontsize=28)
...
ax1.set_zticks([])
ax1.set_axis_off()
ax1.text(7,-0.33*7*np.sqrt(3)+1, -1.7, r"$\hat{d}_{\rm m}(\vec{r})$",fontsize=28)
...
ax5.text(7,-0.33*7*np.sqrt(3)-5.5, 1., r"${d}_{\rm m}(\vec{r})-\hat{d}_{\rm m}(\vec{r})$",fontsize=28)
...
ax6.set_zticks([])
ax6.set_axis_off()
ax6.text(7,-0.33*7*np.sqrt(3)-5.5, 1., r"${d}_{\rm m}(\vec{r})-\hat{d}_{\rm m}(\vec{r})$",fontsize=28)
