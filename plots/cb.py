...
o3 = np.loadtxt('../../nbodykit/fastpm-python/Example_Full/data/ooo.txt')
oo3 = np.zeros((7,7,7))
...
ax.text(5,-0.33*7*np.sqrt(3)-1, 0, r"Far From Origin",fontsize=23)
...
ax1.text(7,-0.33*7*np.sqrt(3), 0, r"Near Origin",fontsize=23)
