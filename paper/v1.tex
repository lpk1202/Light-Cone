...
\ee
Using the quadratic estimator \ec{estlc} we can again use small scale information of the whole light cone (for now we only consider a cube-shaped volume) to infer large scale field of \ec{LC}.
