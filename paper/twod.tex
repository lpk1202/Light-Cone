...
This makes sense since we know that the integral of $M_R^2$ is the area and the additional factor of $L$ in front simply makes $F_R(L)$ dimensionless (no factors of radians). %we also know that the $M$'s will cut off $F_R(L)$ on scales smaller than $L\gg R^{-1}$. 
We are left with
\be
